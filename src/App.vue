<template>
  <div slot="content">
    <div class="select" @click="showPicker(0)" ref="select0">
      {{ selectedText[0] }}
    </div>
    <picker
      ...
      :title="title[0]"
    ></picker>
    <div class="select" @click="showPicker(1)" ref="select1">
      {{ selectedText[1] }}
    </div>
    <picker
    ...
    <div class="select" @click="showPicker(2)" ref="select2">
      {{ selectedText[2] }}
    </div>
    <picker
      @select="handleSelect(2, arguments)"
      :data="data[2]"
    ...
    <div class="select" @click="showPicker(3)" ref="select3">
      {{ selectedText[3] }}
    </div>
    <city-picker
      @select="handleSelect(3, arguments)"
      :data="data[3]"
      :selected-index="selectedIndex[3]"
      ref="picker3"
      :title="title[3]"
    ></city-picker>
  </div>
...
import CityPicker from "./vue-better-picker/components/city-picker.vue";
import {
  provinceList,
  cityList,
  areaList,
} from "./vue-better-picker/data/areaData";
